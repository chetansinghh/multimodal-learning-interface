// ParticipantSignupModal.jsx — Unified email OTP sign in for both participants and admins
import React, { useState } from 'react';
import participantAuthService from '../../services/ParticipantAuthService';
import { useAuth } from '../../context/AuthContext';
import './ParticipantSignupModal.css';

export default function ParticipantSignupModal({ onComplete, sessionId }) {
  const { login } = useAuth();
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    const res = await participantAuthService.sendOTP({ name, email });
    setLoading(false);
    ...
    <div className="signup-modal-overlay">
      <div className="signup-modal-card">
        <div className="signup-modal-header">
          ...
          <h2>Study Sign In</h2>
          <p>Enter your information to receive your email verification code.</p>
        </div>
